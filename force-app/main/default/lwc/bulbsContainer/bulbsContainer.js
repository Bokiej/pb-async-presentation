...
export default class BulbsContainer extends LightningElement {
    ...
    wireBulbResolved = false;
    otherBulbsResolved = false;

    isRendered = false;

    get isLoading() {
        return !(this.wireBulbResolved && this.otherBulbsResolved);
    }
